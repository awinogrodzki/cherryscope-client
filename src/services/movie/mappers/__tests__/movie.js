import { mapMovieResponse } from '../movie';
...
describe('movie service get movie details response mapper', () => {
  it('should map movie details', () => {
    expect(mapMovieResponse(mockMovieResponse)).toEqual(mappedMovieResponse);
  });
});
